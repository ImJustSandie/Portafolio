...
export const ContactForm: React.FC = () => {
  ...
  const inputClasses =
    'w-full bg-p5-black border-2 border-p5-white text-p5-white font-mono text-sm px-4 py-3 placeholder-p5-white/30 focus:outline-none focus:border-p5-red transition-colors';

  return (
    <details className="group mt-8 w-full max-w-2xl">
      <summary className="list-none cursor-pointer">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-p5-black text-p5-white border-4 border-p5-red px-6 py-5 -skew-x-[3deg] shadow-[8px_8px_0_0_#E50012] hover:-translate-y-1 transition-transform">
          ...
          <div className="font-mono text-xs uppercase tracking-widest border-2 border-p5-white px-3 py-2 self-start md:self-auto">
            <span className="lang-es">&gt; CLICK PARA ABRIR</span>
            <span className="lang-en">&gt; CLICK TO OPEN</span>
          </div>
        </div>
      </summary>

      <div className="mt-6">
        <form onSubmit={handleSubmit} className="relative bg-p5-black border-4 border-p5-white p-8 md:p-10 shadow-[6px_6px_0_0_#E50012]">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <button
              ...
              className="font-display text-xl bg-p5-red text-p5-white border-4 border-p5-black shadow-[8px_8px_0_0_#0F0F0F] hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[12px_12px_0_0_#0F0F0F] -skew-x-[6deg] px-8 py-4 transition-all disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:translate-x-0 disabled:hover:shadow-[8px_8px_0_0_#0F0F0F] w-full md:w-auto"
            >
