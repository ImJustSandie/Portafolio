...
export const ContactForm: React.FC = () => {
  ...
  return (
    <div className="group mt-4 md:mt-8 w-full max-w-2xl">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 bg-p5-black text-p5-white border-2 md:border-4 border-p5-red px-3 md:px-6 py-3 md:py-5 -skew-x-[3deg] shadow-[8px_8px_0_0_#E50012] mb-6">
      ...
      <form onSubmit={handleSubmit} className="relative bg-p5-black border-2 md:border-4 border-p5-white p-5 md:p-10 shadow-[6px_6px_0_0_#E50012]">
